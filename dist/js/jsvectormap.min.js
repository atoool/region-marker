    ...
    M = (function (t) {
      function e(e) {
        var i,
          ...
          h = e.labelStyle,
          l = e.labelsGroup;
        ((i = t.call(this) || this).canvas = s.canvas),
          (i.map = s),
  ...
  var _ = (function () {
    function t(t) {
      var e = t.index,
        ...
        o = t.y2,
        h = t.group;
      (this.shape = i.canvas.createLine(
        { x1: a, y1: n, x2: r, y2: o, dataIndex: e },
        s,
        h
      )),
  ...
  var T = {
      handleContainerEvents: function () {
        ...
        this.params.draggable &&
          ...
          w.on(document.body, "mouseup", function () {
            s = !1;
          })),
      ...
      bindContainerTouchEvents: function () {
        ...
        w.on("touchstart", h), w.on("touchmove", h);
      },
            ...
            ? ((o = this.scale),
              ...
              (r = setInterval(function () {
                (g += 1),
                  ...
                  g == v &&
                    (clearInterval(r),
                    m.emit(L.onViewportChange, [m.scale, m.transX, m.transY]));
              }, 10)))
            : ((this.transX = d),
              (this.transY = f),
              (this.scale = t),
              this.applyTransform(),
              this.emit(L.onViewportChange, [
                this.scale,
                this.transX,
                this.transY,
              ]));
      ...
      visualizeData: function (t) {
        "object" == typeof t && (this.dataVisualization = new A(t, this));
      },
    },
    z = (function () {
      function t(t) {
      ...
      return (
        (e.init = function (t) {
          ...
          (this.container = h(t)),
            ...
            (this.canvas = new y(this.container)),
